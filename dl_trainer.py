...
_support_dnns = ['resnet50', 'resnet20', 'resnet56', 'resnet110', 'vgg19', 'vgg16', 'alexnet', 'lstman4', 'lstm', 'googlenet', 'inceptionv4', 'inceptionv3', 'vgg16i', 'mnistnet', 'fcn5net', 'lr']
...
class DLTrainer:
    ...
    def __init__(self, rank, size, master='gpu10', dist=False, ngpus=1, batch_size=32, 
    ...
    def init_fp16(self):
        model, optim = apex.amp.initialize(self.net, self.optimizer, opt_level='O1', loss_scale=128.0)
        self.net = model
